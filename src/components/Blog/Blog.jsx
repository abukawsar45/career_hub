    ...
    return (
        <div>
            ...
            <div className='bg-sky-200 p-2 md:p-6 rounded-sm'>
                    <div className='bg-slate-300 p-2 md:p-4'>
                    ...
                    <div>
                        ...
                        <>
                            ...
                            <li>When you have deeply nested components that require access to data: Passing props down multiple levels of the component tree can become tedious and lead to prop drilling. Context can simplify this process by allowing data to be accessed from any component in the tree without the need to pass props down manually.</li>
                            <li>When you want to avoid unnecessary re-rendering of components: Using Context can be a way to avoid unnecessary re-rendering of components that are not affected by the change in data.</li>
                            <li>When you need a global state management solution: Context can be used to create a global state management solution, allowing you to easily manage and update data across your entire application.</li>
                        </>
                    </div>
                    </div>
                    <div className='bg-slate-300 p-2 md:p-4'>
                        ...
                        <div>
                            <p>A custom hook is a JavaScript function that starts with the word "use" and can use other built-in React hooks or other custom hooks. It allows you to encapsulate reusable functionality and state logic into a single function that can be used across multiple components.Here are some more details about custom hooks:</p>
                            <>
                    ...
                    <div className='bg-slate-300 p-2 md:p-4'>
                        <h3 className='font-semibold text-xl my-2'>3.What is useRef?</h3>
                        <div>
                            <p>The useRef Hook allows you to persist values between renders.
                                It can be used to store a mutable value that does not cause a re-render when updated.
                                It can be used to access a DOM element directly.useRef is a built-in hook in React that allows you to create a mutable reference that persists across re-renders of a component. It returns an object with a current property, which you can use to store any mutable value.
                                Here are some other use cases for useRef:</p>
                            <>
                                <li>To store a mutable value that needs to persist across re-renders of a component, such as a counter or a timer.</li>
                                <li>To store a reference to a child component, so that you can access its properties or methods directly.</li>
                                <li>To access the DOM directly, such as to set focus on an input element or to trigger a scroll event.</li>
                            </>
                        </div>
                    </div>
                    <div className='bg-slate-300 p-2 md:p-4'>
                        <h3 className='font-semibold text-xl my-2'>4.What is useMemo?</h3>
                        <div>
